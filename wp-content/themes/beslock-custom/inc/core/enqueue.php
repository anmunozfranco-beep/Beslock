...
add_action( 'wp_enqueue_scripts', function() {
  ...
  $header_layout_css = $theme_dir_path . '/assets/css/layout/header.css';
  if ( file_exists( $header_layout_css ) ) {
    wp_enqueue_style(
      'beslock-header-layout',
      $theme_dir_uri . '/assets/css/layout/header.css',
      array( 'beslock-main-style' ),
      filemtime( $header_layout_css )
    );
  }

  $header_component_css = $theme_dir_path . '/assets/css/components/header.css';
  if ( file_exists( $header_component_css ) ) {
    wp_enqueue_style(
      'beslock-header-component',
      $theme_dir_uri . '/assets/css/components/header.css',
      array( 'beslock-main-style', 'beslock-header-layout' ),
      filemtime( $header_component_css )
    );
  }
  ...
  $header_component_js = $theme_dir_path . '/assets/js/components/header.js';
  if ( file_exists( $header_component_js ) ) {
    wp_enqueue_script(
      'beslock-header-component-js',
      $theme_dir_uri . '/assets/js/components/header.js',
      array( 'beslock-main-js' ),
      filemtime( $header_component_js ),
      true
    );
  }

  $mobile_drawer_js = $theme_dir_path . '/assets/js/components/mobile-drawer.js';
  if ( file_exists( $mobile_drawer_js ) ) {
    wp_enqueue_script(
      'beslock-mobile-drawer-js',
      $theme_dir_uri . '/assets/js/components/mobile-drawer.js',
      array( 'beslock-main-js' ),
      filemtime( $mobile_drawer_js ),
      true
    );
  }
  ...
  wp_enqueue_script(
    ...
    [ 'beslock-main-js', 'beslock-mobile-drawer-js' ],
    $ver_models_js,
    true
  );
  ...
  $product_card_css = $theme_dir_path . '/assets/css/components/product-card.css';
  if ( file_exists( $product_card_css ) ) {
    wp_enqueue_style(
      'beslock-product-card',
      $theme_dir_uri . '/assets/css/components/product-card.css',
      [ 'beslock-main-style' ],
      filemtime( $product_card_css )
    );
  }

  $product_card_js = $theme_dir_path . '/assets/js/components/product-card.js';
  if ( file_exists( $product_card_js ) ) {
    wp_enqueue_script(
      'beslock-product-card-js',
      $theme_dir_uri . '/assets/js/components/product-card.js',
      [ 'beslock-main-js' ],
      filemtime( $product_card_js ),
      true
    );
  }
