...
![Vista general de e-Touch](assets/e-touch/review-draft/e-touch-hero-main.webp)
![Contexto instalado de e-Touch](assets/e-touch/review-draft/e-touch-installed-context.webp)
...
![Alta de administrador en e-Touch](assets/e-touch/review-draft/e-touch-add-admin-action.webp)

Flujo sugerido:
1. activa la zona numerica integrada en la manija
2. entra al flujo de administracion correspondiente
3. registra el acceso del administrador
4. valida el gesto de toque y la respuesta del equipo

## 5. Uso de PIN integrado
![Uso de PIN en e-Touch](assets/e-touch/review-draft/e-touch-pin-use.webp)
...
![Registro de huella en e-Touch](assets/e-touch/review-draft/e-touch-fingerprint-use.webp)
![Alta del dispositivo en e-Touch](assets/e-touch/review-draft/e-touch-app-add-device.webp)
![Vinculacion contextual por QR en e-Touch](assets/e-touch/review-draft/e-touch-link-qr.webp)

Usa este bloque para explicar:
1. registro de huellas
2. gestion de miembros
3. contrasenas temporales o de un solo uso
4. validacion de accesos desde la app Tuya

## 7. Ajustes e idioma en flujos condicionales
![Ajustes condicionales en e-Touch](assets/e-touch/review-draft/e-touch-language-settings.webp)
...
![Revision de huella en e-Touch](assets/e-touch/review-draft/e-touch-troubleshoot-fingerprint.webp)
![Revision de app en e-Touch](assets/e-touch/review-draft/e-touch-troubleshoot-app-connection.webp)
![Soporte documental de e-Touch](assets/e-touch/review-draft/e-touch-downloads-docs.webp)
