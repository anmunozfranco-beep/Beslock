...
![Vista general de e-Shield](assets/e-shield/review-draft/e-shield-hero-main.webp)
![Contexto instalado de e-Shield](assets/e-shield/review-draft/e-shield-installed-context.webp)
...
![Alta de administrador en e-Shield](assets/e-shield/review-draft/e-shield-add-admin-action.webp)

El flujo recomendado para web es:
1. activar el teclado exterior
2. entrar al menu principal
3. abrir la configuracion de usuarios
4. seleccionar agregar administrador
5. registrar el metodo de acceso del administrador
6. guardar y probar el acceso

## 5. Registrar PIN o contrasena
![Registro de PIN en e-Shield](assets/e-shield/review-draft/e-shield-pin-use.webp)
...
![Registro de huella en e-Shield](assets/e-shield/review-draft/e-shield-fingerprint-use.webp)

Para la web, resume este proceso asi:
1. entra al menu de usuarios
2. elige huella o tarjeta
3. sigue la captura o enrolamiento hasta la confirmacion
4. valida el acceso creado varias veces

## 7. Ajustes del sistema e idioma
![Ajustes de e-Shield](assets/e-shield/review-draft/e-shield-language-settings.webp)
...
## 8. App y gateway
![Alta del dispositivo en e-Shield](assets/e-shield/review-draft/e-shield-app-add-device.webp)
![Vinculacion contextual por QR en e-Shield](assets/e-shield/review-draft/e-shield-link-qr.webp)
...
![Revision de huella en e-Shield](assets/e-shield/review-draft/e-shield-troubleshoot-fingerprint.webp)
![Revision de app en e-Shield](assets/e-shield/review-draft/e-shield-troubleshoot-app-connection.webp)
...
![Soporte documental de e-Shield](assets/e-shield/review-draft/e-shield-downloads-docs.webp)
