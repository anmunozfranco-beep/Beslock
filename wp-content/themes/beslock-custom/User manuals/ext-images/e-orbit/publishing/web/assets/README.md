...
## 1. Objetivo
Esta carpeta está pensada para almacenar los assets visuales de `e-Orbit` usados en el manual, el centro de ayuda y futuras implementaciones web o CMS.
...
- `e-orbit-hero-main.jpg` → hub principal
- `e-orbit-installed-context.jpg` → primeros pasos
- `e-orbit-add-admin-action.jpg` → agregar administrador
- `e-orbit-pin-use.jpg` → registrar PIN
- `e-orbit-fingerprint-use.jpg` → registrar huella
- `e-orbit-language-settings.jpg` → cambiar idioma
- `e-orbit-app-add-device.jpg` → agregar dispositivo
- `e-orbit-link-qr.jpg` → vincular por QR
- `e-orbit-troubleshoot-fingerprint.jpg` → no reconoce huella
- `e-orbit-troubleshoot-app-connection.jpg` → no conecta a la app
- `e-orbit-downloads-docs.jpg` → descargas
