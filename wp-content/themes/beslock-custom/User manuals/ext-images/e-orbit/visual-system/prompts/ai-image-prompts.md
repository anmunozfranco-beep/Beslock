...
## Purpose
This is the canonical e-Orbit prompt pack inside the product-domain visual system.

All new work in this file must execute through ComfyUI workflows and follows `../../../../visual-system/shared/visual-rules/manual-image-reset-policy.md`.
...
## Reference basis
- Use `../../source-of-truth/product-images/e-Orbit.png` as the geometry anchor for every new composition.
- Build this cycle from zero; do not inherit crops, overlays, or framing from older generated outputs.
- Re-check `../references/e-orbit-visual-profile.md` before changing handle, keypad, sensor, or interior relationships.
