...
## Purpose
This is the canonical e-Orbit matrix inside the product-domain visual system.
...
All new slot execution must happen through a ComfyUI workflow or a deterministic compositing fallback that preserves the real product cutout.
...
- Review against `../validations/visual-validation.md`, `../../../../visual-system/shared/generation-guides/review-checklist.md`, and `../../../../visual-system/shared/visual-rules/manual-image-reset-policy.md`.
