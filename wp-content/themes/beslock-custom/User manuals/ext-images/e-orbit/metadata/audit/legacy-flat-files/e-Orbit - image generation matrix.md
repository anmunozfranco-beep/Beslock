...
> Reset note: This flat file is retained only as historical context. Do not use it for new manual imagery after the 2026-05-13 schematic or hybrid reset. Use `ext-images/e-orbit/visual-system/` instead.
