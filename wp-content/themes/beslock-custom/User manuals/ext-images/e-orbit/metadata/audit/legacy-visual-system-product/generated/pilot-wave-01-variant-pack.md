...
- The canonical visual anchor is `../../../../ext-images/e-orbit.webp`.
- The instructional context is grounded in:
  - `generated_manuals/e-orbit/manual.md`
  - `User manuals/e-Orbit user manual - image-ready.md`
...
Use the base negative prompt from `../ai-image-prompts.md` plus these additions:
...
- Review them against `../visual-validation.md` and `../../shared/generation-guides/review-checklist.md`.
- Log each winning raw filename in `selected-assets-register.md` before any stable asset is published.
