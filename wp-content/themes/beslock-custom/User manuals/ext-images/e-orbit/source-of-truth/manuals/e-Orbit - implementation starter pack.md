...
## 3.1 Paquete documental actual
- `e-Orbit user manual - image-ready.md` -> manual de uso final actual
- `e-Orbit app manual.md` -> base normalizada de app a partir de las fuentes OEM suplementarias
- `e-Orbit - supplemental source review.md` -> auditoria de `e-Orbit_1.xls` y `e-Orbit_2.pdf`

## 3.2 Estado tecnico pendiente
- manual de instalacion pendiente: las nuevas fuentes no incluyen montaje fisico ni despiece de perforacion
- plantilla de instalacion pendiente: no existe cotado de corte ni escala 1:1 suficiente para normalizar una template real
