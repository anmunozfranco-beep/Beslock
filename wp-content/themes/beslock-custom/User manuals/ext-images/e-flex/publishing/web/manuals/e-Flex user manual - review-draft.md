...
![Hero de e-Flex para revision](assets/e-flex/review-draft/e-flex-hero-main.webp)
![Contexto instalado de e-Flex](assets/e-flex/review-draft/e-flex-installed-context.webp)
...
![Alta de administrador en e-Flex](assets/e-flex/review-draft/e-flex-add-admin-action.webp)

Flujo recomendado:
1. activa el panel frontal
2. entra al menu de usuarios o administracion de la cerradura
3. elige la opcion para agregar administrador
4. registra al menos un PIN y una huella de respaldo
5. guarda el registro y prueba el acceso de inmediato

## 5. Registrar una contrasena o PIN
![Registro de PIN en e-Flex](assets/e-flex/review-draft/e-flex-pin-use.webp)
...
![Registro de huella en e-Flex](assets/e-flex/review-draft/e-flex-fingerprint-use.webp)

Para registrar una huella de forma consistente:
1. entra al alta de usuarios desde el panel
2. elige huella como metodo de acceso
3. coloca el dedo limpio y seco sobre el lector
4. repite el apoyo hasta completar el registro
5. valida el acceso varias veces seguidas

## 7. Ajustes basicos e idioma
![Ajustes basicos en e-Flex](assets/e-flex/review-draft/e-flex-language-settings.webp)
...
![Alta de dispositivo en e-Flex](assets/e-flex/review-draft/e-flex-app-add-device.webp)
![Vinculacion contextual por QR en e-Flex](assets/e-flex/review-draft/e-flex-link-qr.webp)
...
![Revision de huella en e-Flex](assets/e-flex/review-draft/e-flex-troubleshoot-fingerprint.webp)
![Revision de app en e-Flex](assets/e-flex/review-draft/e-flex-troubleshoot-app-connection.webp)
...
![Soporte documental de e-Flex](assets/e-flex/review-draft/e-flex-downloads-docs.webp)
