 ...
 * Usage (dry-run):
 *   wp eval-file wp-content/themes/beslock-custom/tools/recovery/portfolio/fix-placeholder-images.php -- --dry-run
 * Usage (apply):
 *   wp eval-file wp-content/themes/beslock-custom/tools/recovery/portfolio/fix-placeholder-images.php
 *
 * What it does:
