<?php
/**
 * BESLOCK customer POS completed order email.
 *
...
do_action( 'woocommerce_email_header', esc_html__( 'Compra POS completada', 'beslock-custom' ), $email );
...
<div class="email-introduction">
	...
	<p><?php esc_html_e( 'Tu compra en punto de venta quedó completada. Te dejamos el resumen para que tengas el soporte de la transacción.', 'beslock-custom' ); ?></p>
</div>
