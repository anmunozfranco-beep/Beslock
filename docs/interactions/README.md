...
```text
wp-content/themes/beslock-custom/data/interactions/
  interactions.json

tools/plugins/interactions/
  exporter_interactions.zip
  importer_interactions.zip
...
- paquete instalable exporter: `tools/plugins/interactions/exporter_interactions.zip`
- paquete instalable importer: `tools/plugins/interactions/importer_interactions.zip`
