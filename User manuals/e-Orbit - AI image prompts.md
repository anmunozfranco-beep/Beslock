...
4. `e-orbit-fingerprint-use`
5. `e-orbit-language-settings`
6. `e-orbit-app-add-device`
7. `e-orbit-link-qr`
8. `e-orbit-troubleshoot-fingerprint`
9. `e-orbit-troubleshoot-app-connection`
10. `e-orbit-downloads-docs`
