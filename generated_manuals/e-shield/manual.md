...
administradores como de usuarios regulares.
Tecla *: Tecla de borrar o retroceder. Al ingresar una contraseña, púlsela para borrar el
último digito.
Tecla #: Tecla de confirmación, acceso al menú de funciones o timbre.
- [ ] 2. Restaurar ajustes de fábrica
Mantenga presionado el botón interno SET en el panel posterior.
La voz indicará: "Para restaurar los ajustes de fábrica, presione # para confirmar o * para cancelar".
Presione 4 y el sistema se reiniciará al modo de fábrica.
> ⚠️ Nota: En estado de fábrica, cualquier huella o contraseña puede abrir la cerradura.
El restablecimiento no borrará los parámetros de dirección de giro ni de torsión ya configurados.
- [ ] 3. Aviso de batería baja
Cuando la bateria sea inferior al 25%, el sistema emitirá el aviso: "Bateria baja, por favor
reemplace las baterías". Tras el aviso, podrá abrir la cerradura unas 50 veces más, pero se
recomienda cargarla o cambiar las pilas de inmediato.
- [ ] 4. Alimentación de emergencia por USB
Si la batería se agota, conecte una bateria externa (Power Bank) al puerto USB mediante un
...
Al abrir con contraseña, puede añadir números aleatorios antes y después de su código real
(siempre que el total no supere los 16 dígitos). Presione “#" al finalizar para confirmar.
Esto evita que terceros memoricen su código real.
...
Dentro del menú, la voz indicará: "Presione 1 para Ajustes de Administrador, 2 para Ajustes de
Usuario, 3 para Ajustes del Sistema, 4 para Restaurar ajustes de fábrica y * para salir".
- [ ] 3. Añadir un Administrador (Tecla 1)
En el menú principal, presione 1. La voz dirá: "Ingrese contraseña, huella o tarjeta a añadir".
Huella: Coloque el dedo en el sensor. Al aviso "Presione de nuevo", repita el proceso 3 veces
(varie ligeramente la posición para mejor lectura).
...
4.Añadir un Usuario Regular (Tecla 2)
...
Ingrese al menú principal y presione 4. Ingrese la contraseña de administrador para
confirmar.
> ⚠️ Atención: Se borrarán todos los datos de usuario. Opere con precaución.
- [ ] 7. Ajustes del Sistema

## Ingrese Al Menú Principal Y Presione La Tecla Correspondiente A La Configuración Del

sistema (idioma, volumen, etc.) según las indicaciones de voz.
Modelo: NXS-L
Material: Aluminio + Hierro inoxidable
Tamaño frontal: 145*58*50
Tamaño posterior: 130*110*SO
Grosor de puerta aplicable: 30-110 mm
Tipo de puerta: Puerta de hierro /acero inoxidable / patio
Tipo de cilindro: Cilindro de cerradura Clase C
Tipo de pestillo: Acero inoxidable 304
Tipo de mortaja: Semiautomatica
Vida util: 100,000 veces
Capacidad de huellas dactilares: 100 unidades (9 administradores / 91 usuarios)
Capacidad de tarjetas: 100 unidades (9 administradores / 91 usuarios)
Capacidad de contraseñas: 100 unidades (9 administradores / 91 usuarios)
Longitud de la contraseña: 6-8 digitos
Llave: 2 llaves de latón
Tasa de falso reconocimiento: <0.001%
Tasa de falso rechazo: <0.1%
Temperatura de funcionamiento: -10°C a 68°C
Corriente de funcionamiento: <200 mA
Humedad de funcionamiento: 20%-93% RH
...
## 2.2 Actualización De Cerraduras
...
El administrador original puede borrar, restablecer, enviar y modificar la eKey. Al
mismo tiempo podrá buscar el registro de accegps a la cerradura
bee te ales 7
...
En la aplicación se podrá visualizar mediante dos colores la fecha limite de las llaves
...
se registre
oo rmacigatenios | Inteem gerade codigo de ag Informa once id aude ap
...
exacta (AAAA-MM-DD) (hh:mm); si el periodo de
validez es superior a un año. la exactitud será mensual were o j
(AAAAMM) O ot as anette
Cuando se ingrese un nuevo codigo temporal. este A AR
...
o La hoscor de em sor remola ce larjetas se muestra en caso de que exmla ia Gateway, sero s “o "ay, e elemento se
var are oc. lo
...
dentro ce rango
- [ ] 8. Gestión de asistencia
La aplicación cuenta con un control de acceso que también podrá utilizarse para la gestión de
asistencia de las empresas La aplicación contiene funciones de gestión de empleados,
estadisticas de asistencia y más
...
En la configuracuón del sistema. se incluye el interruptor de toque para abrir. gestión de grupo,
...
O Haga cic en el clero que desea ve” para obleres a información de la cerradura de a puerta

## 9.3 Grupo De Dispositivos

En caso de tener un gran número de dispositivos enlazados, podrá utilizar el apartado “Grupo de
dispositivos” situado en la configuración y presionando el ícono “+” de la esquina superior
derecha para organizarlos mediante carpetas.
hen tae arm tenes oe
O Para e me rar un grupo o modi car 5. “ome, cesiizar a la 29. esca junto al “ombre

## 9.4 Transferir Derechos De Administrador

El administrador original puede transferir la cerradura a otros usuarios. Solo el administrador
original podrá transferirla. Después de introducir la cuenta a la que se desee transferir el dominio,
...
mu «le rar? ‘
Si la cerradura presenta fallas podrá eliminaria Ta = .
directamente desde la configuración de la en
aplicación o Oe ears .
sentis ine Ñ
orga ame .
...
A Haga clic en “IM” de la esquina supenor izquierda y diríjase al
apartado “Gateway”
B Para agregar el Gateway a la aplicación, haga clic en el “+” de
...
1. Bienvenido al manual de configuración para la aplicación TECDOFY. En este manual, le
2. funciones de la app.
3. Es importante que, para conectar la aplicación correctamente a su dispositivo, éste se encuentre
4. 2. Gestión de cerraduras 7. Desbloqueo por Bluetooth
5. La primera vez que utilice la aplicación de la cerradura, $1 no hay datos previos de la cerradura,
6. cerradura debe realizarse por Bluetooth junto a la cerradura
7. La cerradura debe añadirse a la aplicación antes de poder utilizarse Para esto sitúe
8. F aplicación
9. primero de la aplicación para registrarla de nuevo
10. El usuario puede actualizar la cerradura desde el apartado de “Configuración” en la aplicación
11. La actualizacion debe realizarse a través de Bluetooth situando el dispositivo móvil junto a la
12. no se cuenta con este dispositivo, será necesario calibrarlo mediante el Bluetooth del teléfono
13. realizarse a través de Bluetooth situando el A
14. En la aplicación se podrá visualizar mediante dos colores la fecha limite de las llaves
15. email, whatsapp. etc En este . °
16. de la tarjeta desde la aplicación.
17. 7. Desbloqueo por Bluetooth
18. Los usuarios de la aplicación podrán bloquear la
19. cerradura a través de Bluetooth y también podrán
20. la aplicación haciendo clic en el botón con el símbolo
21. La aplicación cuenta con un control de acceso que también podrá utilizarse para la gestión de
22. asistencia de las empresas La aplicación contiene funciones de gestión de empleados,
23. desactivarla desde la aplicación en el apartado de configuración
24. dispositivo, dirijase a la configuración de la aplicación y
25. aplicación o Oe ears .
26. En este apartado puede comprobar que la aplicación se encuentre en su última versión de
27. La cerradura cuenta con conexión Bluetooth de forma predeterminada, sin embargo no contará con conectividad WiFi El Gateway fungira
28. como puente entre la cerradura y una red doméstica de WiFi. A través
29. B Para agregar el Gateway a la aplicación, haga clic en el “+” de
30. D Siga las instrucciones de la aplicación para completar el enlace
...
1. 2.3 Fecha y nora. diagnóstico ae errores
2. 2.3 Fecha y hora, diagnóstico de errores
3. El diagnóstico de errores tiene como objetivo a a tia ta
4. ayudar a analizar los problemas del sistema Debe noe es ae aad
5. Terror Aerea Ur me ads Tp Dean a Cte
